...
const SecurityDashboard = () => {
  ...
  const fetchSbomData = async (hostname = "") => {
    ...
    try {
      const url = hostname
        ? `${API_BASE_URL}/sbom/data?hostname=${hostname}`
        : `${API_BASE_URL}/sbom/data`;
    ...
    if (searchTerm) {
      filtered = filtered.filter(
        (item) =>
          ...
          (item.asset_ip &&
            item.asset_ip.toLowerCase().includes(searchTerm.toLowerCase())) ||
  ...
  const getVulnerabilityBadge = (vulnerabilities) => {
    if (
      !vulnerabilities ||
      vulnerabilities.includes("No known vulnerabilities")
    ) {
      return (
        <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">
          ✅ No Issues
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  SBOM Vulnerability Analysis & Qualys Management
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="Search packages, hostnames, or vulnerabilities..."
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      fetchSbomData(e.target.value);
                    }}
                  >
                    <option value="">All Hostnames</option>
                    {getUniqueHostnames().map((hostname) => (
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {
                        getFilteredSbomData().filter(
                          (item) =>
                            item.verdict &&
                            item.verdict.includes("Requires Legal Review")
                        ).length
                      }
                    </p>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600">
                  Showing vulnerabilities and license compliance for installed
                  packages
                </p>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    ) : getFilteredSbomData().length === 0 ? (
                      <tr>
                        <td
                          colSpan="6"
                          className="px-6 py-12 text-center text-gray-500"
                        >
                          No SBOM data found. Run the SBOM client on your
                          machines to populate data.
                        </td>
                      </tr>
                    ) : (
                        ...
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            <div className="space-y-1">
                              ...
                              {item.vulnerabilities &&
                                item.vulnerabilities.length > 50 && (
          ...
          <div className="space-y-6">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {
                        [
                          ...new Set(
                            getFilteredQualysData().map((item) => item.asset_id)
                          ),
                        ].length
                      }
                    </p>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {
                        getFilteredQualysData().filter(
                          (item) => item.qds_severity === "CRITICAL"
                        ).length
                      }
                    </p>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600">
                  {showCriticalOnly
                    ? "Showing critical vulnerabilities only"
                    : "Showing all vulnerability detections"}
                </p>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    {loading ? (
                      ...
                      <tr>
                        <td
                          ...
                          className="px-6 py-12 text-center text-gray-500"
                        >
                          No Qualys data found. Click "Import Data" to fetch
                          vulnerability data.
                        </td>
                      </tr>
                    ) : (
                      getFilteredQualysData().map((item, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            {item.ssl && (
                              <div className="text-xs text-green-600">SSL</div>
                            )}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span
